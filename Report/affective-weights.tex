...
and expected-utility theory the two parameters
are combined in
...
and lossos  $w^{-}$ \autocite{abdellaoui2010separating}.
...
outcomes. It also violates the probability-
outcome independence that both EUT and PT hold,
...
at around $0.3-0.4$ rather than $0.5$
...
independently and not collapsed to one
...
\autocite{gonzalez1999shape,
wu1996curvature,
gonzalez1994abdellaoui2010separating}.
