...
it follows from \textcite{rottenstreich2001money}
...
ability to detect an effect and is influenced by
...
Additionally, this study does not conduct
...
participants and can be converted to $w(p)$.
CE will be measured on a scale of $0-500$ dollars
...
ordered based on overall means. The
...
strongly believe that formalization is \emph{the} way to
make DM and psychology generally a more
reproducible and predictive science.
The \textcite{
rottenstreich2001money} study
...
their stylized effect. Testing it across more
than two levels of affect-richness and across
enough uncertainty
